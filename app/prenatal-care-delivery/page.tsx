        ...
        <div className="card-custom bg-white p-8 md:p-12">
          <div className="prose prose-charcoal max-w-none">
            ...
            <p className="text-charcoal/80 leading-relaxed mb-6">
              This page has been set up with the correct global shell and design elements. It is currently ready to receive detailed copy and custom layouts for <strong>Prenatal Care & Delivery</strong> from subsequent prompts.
            </p>
